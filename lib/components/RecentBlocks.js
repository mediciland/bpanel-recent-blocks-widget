...
{ /* <div className={'row no-gutters mt-3 justify-content-center align-items-center'}> */ }
{ /*  <button */ }
{ /*    className={'fn-button flo-data-badge'} */ }
{ /*    onClick={() => getRecentBlocks(this.blockCount + recentBlocks.length)} */ }
{ /*  > */ }
{ /*    Get More Blocks */ }
{ /*  </button> */ }
{ /* </div> */ }
